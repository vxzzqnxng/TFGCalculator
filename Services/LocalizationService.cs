...
public class LocalizationService
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _t = new()
    {
        ["ru"] = new()
        {
            ...
            ["SearchModpack"] = "Поиск модпака...",
            ["SelectItem"] = "Выберите предмет",
            ["SearchItem"] = "Поиск предмета...",
            ["Calculate"] = "Рассчитать",
            ["SupportCreator"] = "Поддержать создателя",
            ["BackToModpacks"] = "Назад к выбору модпака",
            ["BackToItems"] = "Назад к выбору предметов",
            ["NothingFound"] = "Ничего не найдено",
            ["AmountPerSec"] = "Кол-во/сек:",
            ["Machines"] = "Механизмы",
            ["RawResources"] = "Базовые ресурсы",
            ["BaseResource"] = "Базовый ресурс",
            ["Storage"] = "Хранилище",
            ["Level"] = "Уровень",
            ["Coil"] = "Катушка",
            ["Quantity"] = "Кол-во",
            ["Resource"] = "Ресурс",
            ["PerSec"] = "/сек",
            ["NoMachines"] = "Нет механизмов",
            ["NoResources"] = "Нет базовых ресурсов",
            ["NoData"] = "Нет данных для отображения.",
            ["ReturnHome"] = "Вернуться на главную",
            ["SiteTFG"] = "Сайт TFG",
            ["GitHubTFG"] = "GitHub TFG",
            ["ReportBug"] = "Сообщите об ошибке",
            ["GitHubProject"] = "GitHub проекта",
            ["SelectRecipe"] = "Выбрать рецепт",
            ["ChangeRecipe"] = "Изменить рецепт",
            ["Name"] = "Название",
            ["Type"] = "Тип",
            ["Tag"] = "Тег",
            ["Machine"] = "Механизм",
            ["CycleDetected"] = "Цикл",
            ["TotalEnergy"] = "Суммарная энергия",
            ["EnergyPerTick"] = "Энергия/тик",
            ["AddItem"] = "Добавить предмет",
            ["AddTree"] = "Добавить древо",
            ["DeleteTree"] = "Удалить",
            ["Rename"] = "Переименовать",
            ["TreeName"] = "Название древа",
            ["GoToTree"] = "Перейти к древу",
            ["RatePerSecond"] = "Скорость/сек",
            ["RateMachines"] = "Кол-во механизмов",
            ["RateViewOnly"] = "Только рецепты",
            ["Amps"] = "Ампер",
            ["VoltageLevel"] = "Ур. напряжения",
        ...
        ["en"] = new()
        {
            ...
            ["SearchModpack"] = "Search modpack...",
            ["SelectItem"] = "Select item",
            ["SearchItem"] = "Search item...",
            ["Calculate"] = "Calculate",
            ["SupportCreator"] = "Support creator",
            ["BackToModpacks"] = "Back to modpack selection",
            ["BackToItems"] = "Back to items",
            ["NothingFound"] = "Nothing found",
            ["AmountPerSec"] = "Amount/sec:",
            ["Machines"] = "Machines",
            ["RawResources"] = "Raw resources",
            ["BaseResource"] = "Raw resource",
            ["Storage"] = "Storage",
            ["Level"] = "Level",
            ["Coil"] = "Coil",
            ["Quantity"] = "Qty",
